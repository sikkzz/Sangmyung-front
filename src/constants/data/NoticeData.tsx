...
import Img13_1 from "../../assets/partner/safe/1.png";
import Img13_2 from "../../assets/partner/safe/2.jpeg";
import Img13_3 from "../../assets/partner/safe/3.jpeg";
import Img13_4 from "../../assets/partner/safe/4.jpeg";
...
export const NoticeData = [
  ...
  },
  {
    ...
    kind: "제휴",
    content:
      "🌟더 밝게 빛날 나를 위한 선택!🌟<br/>'안전하고 검증된 우리 학교 의료복지!'<br/><br/>✅ 대상: 상명대학교 총학생회 학생 및 가족 (졸업생, 휴학생 포함)<br/><br/>✅ 혜택 내용<br/>1) 전국 250개 제휴 병원 비급여 항목 우대 할인(최대 49%)<br/>2) 인기시술 : 가다실9가, 충치/임플란트, 치아교정, 스마일라식, 기능코, 눈매교정, 피부관리,<br/>점제거, 리프팅, 보톡스/필러, 도수치료, 한약, 반영구, 모발이식, 건강검진, 심리상담<br/>3) 기간: ~ 23.12.31<br/><br/>✅ 상명대학교 전용 혜택 링크:https://smu-seoul.safedoc1.com<br/><br/>💙 제휴병원 이용 방법 및 앱 설치<br/>1) 전화예약 : 02 - 2088 - 8677<br/>2) 카톡채널 '세이프닥' 검색<br/>3) 어플로 언제 어디서나!<br/>📱구글스토어 - https://url.kr/jv1s2f<br/>📱앱스토어 - https://url.kr/kj4g7o<br/><br/>💙예약 신청 시, 꼭 “상명대학교”를 말씀해주셔야 제휴 혜택이 적용됩니다.💙<br/><br/>앞으로도 지속적으로 업로드 될 💡N 번째 최선(先)💡콘텐츠에 많은 관심과 이용 부탁드립니다! 감사합니다.",
    inImg: [
      {
        img: Img13_1,
        alt: "img13_1",
