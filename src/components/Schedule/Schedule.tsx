...
//   const [selectedYear, setSelectedYear] = useState(test.year);
//   const [selectedMonth, setSelectedMonth] = useState(test.month);
...
//     //연도 선택박스에서 고르기
//     let yearArr = [];
//     const startYear = test.year - 10; //현재 년도부터 10년전 까지만
//     const endYear = test.year + 10; //현재 년도부터 10년후 까지만
  ...
  const returnWeek = useCallback(() => {
    ...
    week.forEach((index) => {
      weekArr.push(
        ...
        <div
          key={index}
          className="weekday sunday saturday"
        //   className={cx(
        //     { weekday: true },
        //     { sunday: v === "일" },
        //     { saturday: v === "토" }
      ...
      if (week[day] === nowDay) {
        for (let i = 0; i < dateTotalCount; i++) {
          dayArr.push(
            ...
            <div
              key={i + 1}
              className="today weekday sunday "
            //   className={cx(
            //     {
